...
namespace TaskTracking.DataAccess.Migrations
{
    ...
    [Migration("20260729093226_AddCariTables")]
    partial class AddCariTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskTracking.Entities.Cari", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TaskTracking.Entities.CariHareket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TaskTracking.Entities.CariHareket", b =>
                {
                    b.HasOne("TaskTracking.Entities.Cari", "Cari")
                        .WithMany("Hareketler")
